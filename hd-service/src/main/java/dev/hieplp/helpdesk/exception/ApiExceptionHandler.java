...
/**
 * Maps exceptions to the spec error body {@code {"code","message"}}. {@link ApiException} keeps its
 * own status; malformed input → 400, unknown route → 404, wrong method → 405, anything else → 500.
 */
...
public class ApiExceptionHandler {
  ...
  /** Unreadable body, wrong media type, failed validation, or bad path/query type → 400. */
  @ExceptionHandler({
