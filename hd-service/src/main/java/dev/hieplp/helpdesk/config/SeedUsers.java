...
/**
 * Seeds one agent and one requester on startup (password {@code "secret"}). Skips any account that
 * already exists — safe to run on every boot.
 */
@Component
...
public class SeedUsers implements ApplicationRunner {
  ...
  private void seed(String email, String name, Role role, String password) {
